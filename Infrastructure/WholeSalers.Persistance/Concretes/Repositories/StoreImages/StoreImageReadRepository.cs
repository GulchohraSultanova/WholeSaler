...
{
    public class StoreImageReadRepository : ReadRepository<StoreImage>, IStoreImageReadRepository
    {
        public StoreImageReadRepository(WholeSalersDbContext WholeSalersDbContext) : base(WholeSalersDbContext)
        {
        }
    }
}

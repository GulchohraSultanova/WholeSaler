...
{
    public class ManufacturerImageReadRepository : ReadRepository<ManufacturerImage>, IManufacturerImageReadRepository
    {
        public ManufacturerImageReadRepository(WholeSalersDbContext context) : base(context)
        {
        }
    }
}
